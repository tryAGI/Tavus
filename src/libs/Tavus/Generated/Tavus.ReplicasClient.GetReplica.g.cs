...
namespace Tavus
{
    public partial class ReplicasClient
    {
        ...
        partial void PrepareGetReplicaRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string replicaId);
        partial void ProcessGetReplicaResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetReplicaResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Tavus.Replica> GetReplicaAsync(
            string replicaId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Tavus.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Tavus.AutoSDKHttpResponse<global::Tavus.Replica>> GetReplicaAsResponseAsync(
            string replicaId,
            global::Tavus.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Tavus.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Tavus.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetReplicaAsync",
                                pathTemplate: "$\"/v2/replicas/{replicaId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Tavus.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetReplicaResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Tavus.AutoSDKHttpResponse<global::Tavus.Replica>(
