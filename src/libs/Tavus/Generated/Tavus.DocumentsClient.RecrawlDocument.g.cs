...
namespace Tavus
{
    public partial class DocumentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Tavus.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Tavus.AutoSDKHttpResponse<global::Tavus.Document>> RecrawlDocumentAsResponseAsync(
            string documentId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Tavus.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Tavus.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RecrawlDocumentAsync",
                                pathTemplate: "$\"/v2/documents/{documentId}/recrawl\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
