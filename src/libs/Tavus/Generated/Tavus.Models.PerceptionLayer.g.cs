...
namespace Tavus
{
    ...
    public sealed partial class PerceptionLayer
    {
        ...
        public PerceptionLayer(
            ...
            global::System.Collections.Generic.IList<global::Tavus.ToolDefinition>? visualTools,
            string? audioToolPrompt,
            global::System.Collections.Generic.IList<global::Tavus.ToolDefinition>? audioTools)
        {
